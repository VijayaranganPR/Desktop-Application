/*
new URLSearchParams(string) is a constructor for the URLSearchParams object in JavaScript, 
which creates a new instance of the URLSearchParams object and initializes it with the search parameters specified in the string argument.
