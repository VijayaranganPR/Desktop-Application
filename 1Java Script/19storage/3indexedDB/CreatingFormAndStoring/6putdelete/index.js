/*
put - to update the values of of a object in ObjectStore
    - it askes for new object to be stored

delete - to delete a object from the objectStore
    - it askes for the primary key of the object need to be deleted
*/
...
updateButton.addEventListener('click', (e) => {
    ...
    idValue = document.getElementsByName('personForm')[0].id        // getting id
...
deleteButton.onclick = (e) => {
    ...
    idValue = document.getElementsByName('personForm')[0].id
