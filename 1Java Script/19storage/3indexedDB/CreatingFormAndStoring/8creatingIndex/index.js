/*
To delete object store use
    - db.deleteObjectStore('firstObjectStore')
To create new object index use
    - objectStore.createIndex('nameIndex', 'name',{unique: false})
    - objectStore.createIndex('ageIndex', 'age',{unique: false})
    
    - creating object index will make a copy of the object story with primary key as the indexName
    - this help to navigate through the object store using index which is sorted in ascending order.
*/
