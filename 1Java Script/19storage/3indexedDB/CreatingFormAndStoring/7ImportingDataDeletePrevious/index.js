/*
importing testData which will be added to the database
other previous data will be deleted
    - by using store.clear() to delete all the elements in database
    - by using (for of) and (store.add) to add all elements in database
*/
