...
The findIndex() method is generic. 
...
console.log(inventory.findIndex(findBest)) // 2
...
console.log(inventory.findIndex(findBest1)) // -1
...
a = [1,2,3,4,5]
returned = a.findIndex(checkreturn)
...
console.log([1,2,3,,5].findIndex((x) => {
    console.log(x)
    if (x===undefined){
        return true
    }
...
console.log(a.findIndex(initial), a)  
/*
adding in back
...
console.log(a.findIndex(initial1), a) 
/*
adding in frount
...
console.log(a.findIndex(initial2), a)  
/**
removing from back
...
console.log(a.findIndex(initial3), a)  
/**
removing from frount
